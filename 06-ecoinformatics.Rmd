...
"Ontologies"*" - well-defined concepts or terms that have precise meanings within a specific domain or field, as well as formal mappings of how the terms interrelate
  ...
  - "DarwinCore"- another provider of ontologies, particularly for evolution related concepts.
...
### Fischer *et al*, 2009 {#fischer2009}

*"Integrating resilience thinking and optimisation for conservation"* [@fischer2009integrating]
...
Integrating the two:
  ...
  - Given that one is a perspective and the other is a tool, this implies they may be relevant at different stages of a project or research program and thus may be integrated relatively efficiently
...
The authors identify three themes worth particular attention:
  ...
  2. Addressing uncertainties and interface with decision-making
  3. Avoiding undesirable states that constrain reversibility
...
Social factors can complicate things that may otherwise appear straightforward to optimize. For example: 
  ...
  - Protection of reserves may appear straight forward at first, but may not respond to climate change or other shifting environmental parameters
...
### Chapin *et al*, 2009 {#chapin2010}

*"Ecosystem stewardship: Sustainability strategies for a rapidly changing planet"* [@chapin2009ecosystem]




### Folke *et al*, 2010 {#folke2010}

*"Resilience thinking: Integrating resilience, adaptability and transformability"* [@folke2010resilience]
...
Important to consider both, as often times one things in terms of specified resilience and thus may not be considering important or unexpected shocks.
...
Case studies of social ecological systems suggest transformations occur through three phases:
  ...
  1. Being prepared for or even preparing the social ecological system for change
  2. Navigating transition by making use of crisis as a window of opportunity for change
  3. Building resilience of new social-ecological regime
  


*Questions for consideration*:

  1. Are there deeper, slower variables in social systems, such as identity, core values, and worldviews that constrain adaptability?
  2. What are the features of agency, actor groups, social learning, networks, organizations, institutions, governance structures, incentives, political and power relations or ethics that enhance or undermine social ecological resilience?
  3. How can we assess social ecological thresholds and regime shifts and what governance challenges do they imply?
...
### Cavanaugh, 2014 {#cavanaugh2014}

*"Poleward expansion of mangroves is a threshold response to decreased frequency of extreme cold events"* [@cavanaugh2014poleward]
...
### Eslami-Andergoli, 2015 {#eslamiandergoli2015}

*"Approaching tipping points: A focussed review of indicators and relevance to managing intertidal ecosystems"* [@eslami2015approaching]
