...
They discuss Individual Based Models (IBMs) as useful though limited tools for examining biocomplexity within mangroves, but note that there is relatively little work in this field to date. See section \@ref(chentwilley1998) for an example of using IBMs within mangroves.
