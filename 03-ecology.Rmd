...
Differences in predator distribution may explain some of the variability. In particular, grapsid crabs do not exist in Florida, which may explain lack of consumption of *Rhizophora*. In forests with only snail consumers, only *Avicennia* were consumed.

This may be a result of the feeding mechanisms of crabs versus snails, and the physical structure of *Rhizophora* vs. *Avicennia* propagules.
...
*Insects* - Most common forms of insect herbivory are:
  ...
  2. Wood-boring - very limited evidence (Feller in Belize), but has found to produce leaf-loss as great or greater than direct leaf herbivory. Insects bore wood on branches and leaves along the branch are subsequently lost.
...
The costs of leaf herbivory and stress on the plant are a function of both the direct impacts, as well as the additional biomass and resources needed to be put into regenerating leaves or building defensive mechanisms. Toxins (*E. allagocha*), tannins or thicker leaves may require resource inputs that could otherwise be allocated towards growth.

Ants are the most dominant insects in mangroves, both numerically and energetically, despite the difficult floor conditions in which many require. Comprise of both terrestrial species as well as those endemic to mangroves.
...
Biomass cycling of crabs:
  ...
  2. Additionally, approximately 60% of dry weight is defecated
    ...
    - shredding of leaves occurs, and bacterial diversity on crab fecal matter found to be 70x greater than that of raw leaf litter
...
"Reduced competition from crabs" - Several mechanisms have been proposed for reductions in seedling/sapling competition due to propagule predation:
  ...
  1. *Predation-dependence model* - inverse relationship between rate of predation and dominance of particular species
    - Smith has found support for it, whereas a number of other studies have concluded on alternative mechanisms.
  2. *Canopy-gap mediated model* - hypothesizes that predation is more intence under closed canopies than in light gaps
...
"Bioturbation of soil" - Impacts of crabs as ecosystem engineers may have strong implications for soil quality within mangroves:
  ...
  - Fiddler crabs may increase depth of iron reduction
  - Burrowing which allows water penetration and thus may flush out accumulated salts, particularly within rhizospheres
...
**Key contribution:** This is an extensive review on trophic interactions in mangroves.
...
*Insect herbivory* - General consensus is that insect herbivory is not a significant consideration, although this is likely founded on little evidence. Methodological issues constrain our current estimates of the degree of leaf herbivory by insects.
...
Additionally, occasional mass herbivory events due to emergence of lepidopterans can defoliate massive expanses of trees. Caterpillars emerge and within 3 months trees have lost > 75% of foliage.

*Crab herbivory* - Majority of crabs forage on forest floor, but some have adopted arborial lifestyles. Some are found in both terrestrial and low tree canopies, whereas four species of sesarmid crabs are purely arboreal (come to floor rarely if ever).

  1. *A pisonii* - Atlantic/Caribbean/Eastern Pacific; feeds on young leaves largely from *R mangle*
...
The importance of this particular pathway has since been questioned, as supporting evidence has been circumstantial the large contribution of DOC has become more clear.
...
Little is known about the functional groups and diversity of fungi in mangroves, but they may play a significant role in decomposition of wood and roots. Additionally, wood-boring insects with mutualistic relationships with bacteria that can process lignocellulose may be important for decomposition of woody biomass (e.g., termintes).
...
They attribute approximately two-thirds of the loss of mangroves directly to human related activities.

Furthermore, they delve into the importance of mariculture for mangrove habitat losses. Conversion of mangroves to shrimp ponds is the dominant driver of deforestation, and has additional impacts for example decrease in offshore stocks due to need for juveniles as well as impacts on offshore fisheries which are used as feed.

### Alongi 2002 {#alongi2002}

*"Present state and future of the world's mangrove forests"* [@alongi2002present]
...
As of 2010, current rate of mean sea level rise is 3.2 +/- 0.4 mm per yr (based on satellite altimetry), though these rates likely vary locally.

"Relative sea level rise" refers to the rate of sea level rise in conjunction with subsidence or vertical accretion of coastal areas.

Surface elevation change are a result of both biotic and abiotic processes. Abiotic processes include:

  1. Inorganic sedimentation
  2. Groundwater influx
...
*Subsurface root accumulation* - May be the most important biological contributor to surface elevation change in some settings. Can be significant enough to affect the direction and rate of change in surface elevation. 

  - Refractory nature and existence within anaerobic environment are prone to slow rates of decomposition
...
*Factor affecting root contributions to soil accretion* - In general, the influence or roots on SEC is a relative function of production and decomposition of roots.

  - Salinity - response of root growth to salinity is species dependent, but root growth only slightly reduced with increasing salinity; increases in root to shoot ratio may actually be a result of increased aboveground biomass rather than increased root biomass
  - Nutrients - in general do not see an increase in root production, but rather increases in biomass production aboveground; in some settings may even see decrease in elevation due to release of nutrient-limited microbial communities
  ...
  - Disturbance - may be biotic or abiotic: 
    ...
    - Acute deposition of sediments from storm events may kill trees, or may provide much needed substrate for subsiding forests; root zone expansion following deposition of sediment may further increase surface elevations
    - Lightning may kill trees, causing root collapse and alter microhabitat hydrology
