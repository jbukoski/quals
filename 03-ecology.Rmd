...
*"Mangrove ecosystems: Successional or steady-state?"* [@lugo1980mangrove]
...
### Jimenez *et al*, 1985 {#jimenez1985}

*"Tree mortality in mangrove forests"* [@jimenez1985tree]
...
```{r, echo=FALSE}
knitr::include_graphics(rep("images/jimenez1985.bmp"))
```
...
**Further reading: ** Look into sulfur reduction processes.
...
*Viviparous seedlings* - The salinity of seedlings has been shown to be much lower than that of parent trees. This might increase buoyancy of the propagule and also protect it against very hostile environments. Seedlings quickly take up salts upon establishment, rapidly reaching osmotic potentials of parent trees.
...
*Pneumatophores* - A number of studies have shown that pneumatophores are largely plant systems responsible for exchanges of gases. The discussion of pneumatophores here focused on three primary points:
  ...
  3. *Other purposes* - Pneumatophores may serve other purposes besides gas exchange or respiration. For example:
...
**Key significance: ** This is an excellent review of the ecophysiology (how the physiology of trees responds to particular environmental conditions) of mangrove trees. This paper should be reviewed more than once.
...
*Waterlogging* - Key fact is that oxygen diffuses through air 10,000 times more rapidly than through water, thus root systems of mangroves are adapted such that they avoid extensive inundation through areal roots. 
  ...
  - Degree of soil saturation affects form and availability of different nutrients through redox reactions
    - Different redox pathways will produce different mineral forms of nutrients
  - May have different amounts of availability of P and N along the tidal gradient
    - N primarily exists as ammonia in frequently flooded regions, which binds easily to organic compounds and thus persists within the soil system
...
*Field studies* - Distinct zonation between both species composition and reducing soil conditions and sulphide were seen. Changes in E~h~ and sulphide concentration strongly correlated with shifts in species compositions. 

  - Higher E~h~ was found for mixed basin and fringe forest, whereas lower E~h~ was found with monospecific-basin *Avicennia*
...
Additionally, the presence of both species induced higher redox potential (E~h~) relative to soils without any mangrove seedlings. Addition of sulphide induced a reduction in E~h~.
...
McKee collects a number of edaphic variables (e.g., salinity, sulphide, redox potential, etc.) and then uses PCA to extract three ecologically relevant "factors" that she uses to associate with seedling establishment and survival: i) salinity, ii) inundation, and iii) nutrients/resources. 

This appears to be a clever way of dealing with emergent properties and controls on mangroves and may be of interest for further examining interactive factors.
...
*Sulfate* - Sulfate levels reflected changes in salinity. Sulfate was constant in concentration until 1700 m into the forest (the approximate reach of tidal inundation), at which point it steadily declined. Sulfate concentrations were higher in deep soil water than surface waters.
...
**Five central paradigms** - Krauss *et al* provide five central paradigms that shape a lot of the work thinking and work related to mangrove ecophysiology:
...
**Salinity** - Salinity is one of the major environmental conditions that mangroves have evolved to be able to handle. A wide range of salinity conditions exist upon which mangroves have to be able to tolerate.
...
**Flooding and SLR** - Flooding of mangroves greatly changes the soil conditions within very short time frames (less than a day). Mangrove roots may metabolize anaerobically for short periods of time, but it is often more effective to avoid root hypoxia through internal aeration.
...
Prolonged inundation, for example through sea level rise, reduces growth rates which may negate the effects of CO~2~ fertilization. Over shorter time periods, growth was reduced quickly but normal metabolic functioning quickly rebounded (after a period of a few weeks).

**Biota** - Interacting effects of microconditions within the forest and biota, particularly insects or crabs that are predators of mangroves trees may be significant in establishment of seedlings.
...
**Key significance: ** This review gives an extensive overview of carbon dynamics in mangroves, and goes into the details at a molecular compound level for much of mangrove organic matter. This distinguishes the review from some of the other work that is out there.

**Key notes: **

*Origin of mangrove organic C*

Stable isotopes can be effective in determining sources of organic C in sediments.
...
Mangrove litter thus provide a particular signature that is preserved during transformations and may be helpful in sourcing of organic C in mangroves.
  ...
  - Amino acids form the second most
...
Various controls on the speed at which leaf litter is decomposed exist, for example how wet it is (controls access to microbial decomposers; there is a sweet spot in terms of moisture for litter decomposition), or the C:N ratio of the litter (higher N = faster decomposition rate).
...
Sedimentary decomposition pathways occur largely under anaerobic conditions:
  ...
  - These molecules are then oxidized completely to CO~2~ by a wide variety of anaerobic microorganisms via electron acceptors in the following sequence: Mn^4+^, NO~3~^-^, Fe^3+^, and SO~4~^2-^
  
Aerobic and sulfate reduction are the most important reduction processes in mangroves, and account for approximately 40-50% of OM reduction each. Thus, many mangroves have reduced inorganic S in form of FeS~2~ and S^0^.
...
Sulfur reduction is hampered by the presence of more ready electron acceptors (O~2~ and Fe^3+^), and thus in environments in which Fe^3+^ is high, sulfur reduction may be less significant than Fe respiration.
...
Other studies (see \@ref(lunstrum2014)) have shown that mangrove soil organic carbon concentrations typically increase with time.
...
The influence of OM exported from mangroves is likely limited to within a km or 2 from the forest. The lack of a major outwelling phenomena may be explained by:
  ...
  1. The distribution of exported mangrove litter depends on hydrogeomorphology, which may result in direct sedimentation in immediate vicinity of the forest
  2. Over the time-scale at which outwelling occurs, a significant fraction of litter is lost as DOC
  
Export of carbon to nearshore ecosystem is significant in mangroves and thus loss of mangroves globally may have had significant implications for DOC to the ocean.

### Alongi, 2011 {#alongi2011}

*"Carbon payments for mangrove conservation: Ecosystem constraints and uncertainties of sequestration potential"* [@alongi2011carbon]
...
Woodroffe, 2002 outlines six ways in which mangroves develop in relation to sea-level:
  ...
  1. Static conditions - surface accretes asymptotically until sediment raises forest floor above tidal range
  2. Constantly rising sea level - floor accretes at pace similar to SLR
  3. Fluctuation SLR rates - forest floor accretes with time above tidal range
  4. Stable SL but episodic subsidence - floor accretes back to tidal range
  5. Rising SL and episodic subsidence - response is complex but overall pattern is net accretion
  6. Rising SL but no episodic subsidence or change in sediment volume - floor is set back or abandoned
...
In understanding C sequestration in mangroves, it is critical to understand the various pools from C sequestration by mangrove trees:
  ...
  - Approximately 50% is respired by trees, though this is a rough estimate given limited data, particularly for root systems
...
Over the short-term, C is stored in biomass whereas over the long-term, C is stored primarily belowground.
...
### Asner, 2013 {#asner2013}

*"High-fidelity national carbon mapping for resource management and REDD+"* [@asner2013high]
...
The plot based and lidar based data was scaled to the national level using two different techniques: 

  1. A RandomForest algorithm 
  2. Stratification of satellite input variables into 2039 unique classes.
...
Although the relative contributions depend upon site location and geomorphological conditions, most C is produced *in situ* and stored belowground.
...
Of key significance is that approximately 24 Tg C per yr is buried globally, and approximately 60% of mangrove NPP is estimates to be exported as dissolved and particulate carbon to coastal ocean (~129 Tg C per yr).
