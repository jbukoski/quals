...
Although most soil formation processes are continuous with depth, some occur at abrupt intervals as evidenced by banding within soil profiles.
...
Where m~j~ is the element j, in the soil (s) or parent material (p).
...
Chemical composition of crustal rock on earth is a result of both:
  ...
  2. Differentiation in element composition of the core, mantl and crust.
    - Crust is generally depleted in noble gases, hydrogen, carbon and nitrogen, but enriched in the other elements.
...
In general, soils are:
  ...
  - Very depleted in Mg, Na, Ca, K, and Be (Beryllium) due to aqueous weathering
...
In examining hyper-arid soils, the lack of chemical weathering and atmospheric accretion of chemical constituents results in volumetric expansion of soil and accumulation of essential plant nutrients. This is indicative that at a critical threshold of precipitation, accumulation of soils may occur. This is also indicative of the important of water in chemical weathering processes.

*Matter and energy transfer processes in soils*

Movement of soil constituents can broadly be described as diffusive or advective processes. Study of these processes is largely wrapped up in domain of "soil physics".

  - "Advection" - transport with mean fluid flow
  - "Diffusion" - transport of compounds through action of random motions
  
Diffusive transport is predominant form of movement in soils.

Soil carbon cycle is one of the few chemical constituent cycles that has been described in detail.

*Mechanistic modeling of organic and inorganic carbon in soils*

Extremely important to consider variation in soil carbon with depth. Different soil carbon with depth profiles may emerge. Mollisols remeniscent of mangroves, aridosols relatively low and flat but with some variation, spodosols may have a sharp spike.
...
Where:
  ...
  - -v is advection rate in (cm/yr)
  - z is soil depth in (cm)
...
Modeling carbon movement out of soils:
  ...
  - Various forms of Fick's law have been applied to describe transport of CO~2~ from soils

Important to consider the work of Cerling, 1984 - describing the carbon-isotope composition of soil CO~2~, which he recognized ultimately controls the isotope composition of pedogenic carbonate.
...
The use of the pedogenic carbonate and carbon-isotope model has allowed for:
  ...
  - Description of observed increase in $\delta^{13}C$ for soil CO~2~ and CaCO~3~ with depth
...
Where:
  ...
  - $\rho_s$ and $\rho_r$ are the soil and rock density (c/cm^3^)
