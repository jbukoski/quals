...
*Pedon* - Smallest three-dimensional sampling unit that displays full range of characteristic properties of a particular soil. 

*Polypedon* - A group of closely associated pedons that are commonly found adjacent to another within the field (i.e., slight variations in a one general pedon). Forms a *soil individual*
...
Classifying a soil includes chemical, physical, and biological properties that may be directly observable in the field or quantifiable via lab analyses. The soil taxonomic name that is associated with a particular soil series is built to reflect each of these characteristics.

*Diagnostic soil horizons* are often associated with precise quantitative measure and are used to resolutely identify a soil as particular series or not.
...
The *soil temperature regimes* primarily refer to i) frigid (cold), ii) mesic (moderate), and iii) thermic (hot).
