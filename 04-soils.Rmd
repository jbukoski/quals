...
*Soil water content and water potential* - An inverse relationship exists between the water content of soils and how strongly water is held within soils.

In describing water content of soil, need to describe both the water content as well as the water potential. Behavior of water in soil is typically determined primarily by water potential rather than water content.

"Water content" is defined as a volume of water per volume soil and is typically measured as the difference between wet and dry weights of soil.
...
*Infiltration and percolation* - The texture of a soil and in particular the presence of macropores are critical here.
...
For mangroves, soils are likely saturated with water at most times. Matric potentials and osmotic potentials are likely to be critical for water availability for mangrove vegetation. Preferential flow as a result of bioturbation is likely critical for flushing of the system as well as aerating soil at depth. Given the fine sediment texture of many mangrove forests, there is likely very little pore space for which water and air may enter the soil. Water flushing and aeration may only exist within top 15-20 cm of soil.
...
Reduction-oxidation (redox) describes the chemical processes by which electrons are transferred. Reduction and oxidation occur together, as electrons are transferred from one (the reductant) to the other (the oxidant). Micro-organisms drive majority of redox reactions, often consuming electrons from C or accepting electrons from oxygen. Respiration is largely the consumption of C based electrons from carbohydrates.
...
The redox potential of a soil is a measure of how much oxidation-reduction it is able to perform (i.e., a measure of its ability to accept or donate electrons), and depends upon presence of electron acceptors as well as pH. Redox potential typically decreases as the pH increases.

  - *Oxidizing soils* - accept electrons easily
  - *Reducing soils* - donate electrons easily

Standard E~h~ levels for drained, well-aerated soils are in the 0.4 - 0.7 Volt range, whereas flooded conditions can reduce E~h~ levels to as low as -0.3 V.
...
Only approximately 10% of solar incidence is actually transferred to soil. The majority is intercepted by the atmosphere, by vegetation, or is lost via the evaporation of soil water.
...
The very large surface area to volume ratio of soil colloids is due to both their platelike structure and their presence of internal surfaces within clays. The majority of soil colloids primarily carry more negative electrostatic charges than positive charges.

*Absorption of cations and anions:*

Colloids attract thousands of Al^3+^, Ca^2+^, Mg^2+^, K^+^, ^H+^, and Na^+^ cations, which are loosely bound to the surface of the colloid, often in a hydrated state in moist soils.
...
*Types of soil colloids:*
  ...
  - Noncrystalline silicate clays -- tightly bonded Si, Al and O atoms, but do not exhibit crystalline sheets; high amounts of positive and negative charge, and capable of holding large amounts of water, but exhibit little stickiness
...
*Layered silicate clay structure:* 
...
The nature and combination of sheets in the layers vary, and thus produce the differences in types of clays (and thus their resultant physical and chemical properties).
...
Fe and Al oxides are modified octahedral sheets with Fe or Al in the cation positions, and no tetrahedral sheets or silicon in their structures. 
...
Ions held to external surface of clays via electrostatic attraction, which is relatively weak and thus ions are in constant motion. Ions constantly oscillate between being closer versus slightly further away from the colloid. If an ion in soil solution enters space closer to the colloid, the ions "exchange".

Cation exchange reactions are reversible in that the cations can easily revert back to their original places.

Cation exchange reactions occur on a charge to charge basis (i.e., 2 H^+^ for 1 Ca^2+^).
...
In humid regions, Ca^2+^, Al^3+^, aluminum hydroxy ions and H^+^ are most prominent, whereas Ca^2+^, Mg^2+^, and Na^+^ dominate in more arid regions.
...
*Anion exchange* - Anions are held by colloids in two primary ways:
  ...
  2. Reactions with surface oxides or hydroxides, which form inner-sphere complexes
...
The principle processes that determine soil acidification are:

  1. Production of H+ ions
  2. Washing away of cations by percolating water
  
Both processes are facilitated by volumes of water that percolate through soil, and thus acidity is closely related to the amount of precipitation within a particular region or soil system.
...
In addition, several biological processes can affect the acidity of the soil:
  ...
  1. Plant balancing of cations - when excess of certain cations are taken up by roots, H^+^ often released into soil solution to maintain charge balance
...
*Alkalizing processes* - Reduction of H^+^ or production of OH^-^ in the soil alkalizes the soil. Several pathways of alkalizing processes exist:
  ...
  2. Accumulation of nonacid cations -- nonacid cations from weathering may accumulate in areas of low precipitation (Ca^2+^, Mg^2+^ K^+^, and Na^+^)
...
*Soil buffering* - The ability of a soil to resist changes in pH
...
Manganese may also become toxic under acidic conditions as it is increasingly soluble and taken up in excess quantities. Mn is an essential micronutrient but becomes toxic in excess quantities
...
There are a range of different classifications for soil organisms, but most consider their trophic level (primary producer, primary consumer, etc.) or feeding patterns (fungivore, herbivore, autotrophic, etc.).
...
Total living biomass is generally well-correlated with the dry-weight of organic matter, oftentimes approximately 1-5% of the dry weight of organic matter.

The majority of activity in soils is by microorganisms (estimated at ~80% of total soil metabolism). Nematodes and protozoa play important roles in preying on bacteria and fungi, whereas earthworms can be significant and play an important role as ecosystem engineers.
...
Prokaryotes have enormous diversity (a handful of soil may hold as many species as fauna in the Amazon), and consist of both autotrophs and heterotrophs.
...
Perform important functions within the soil:
  ...
  - Oxidation and reduction of particular elements (e.g., Fe and Mn)
    - N fixation
...
*Controls on soil microorganism growth*:
  ...
  - Exchangeable cations and pH - the acidity of the soil may affect the ability of different micro-organisms to persist
  
*Benefits to plants from soil organisms*:
...
Soil organic matter is critical to soil systems for a variety of reasons, but in particular for increasing CEC, improving water holding capacity, and also its role within the global carbon cycle.
...
Depending on quality and availability, different "pools" of OM can be considered:
  ...
  - Active pool - easily decomposible OM with half-lives of days to a few years (~10-20% of OM)
    - e.g., living biomass, pieces of detritus, mostly polysaccharides, other nonhumic substances
...
N in nitrate is subject to five fates, some of which overlap:
  ...
  5. Conversion to ammonium - dissimilatory (nitrate) reduction to DNRA by anaerobic organisms
...
Ammonium is attracted to the negative surfaces of clays and humus, where it is held in an exchangeable form and is available for plant uptake. May become more permanently fixed in pockets within the crystalline structure of particular 2:1 clay types.
...
Nitrification may be reversed be several bacterial processes, some of which occur in anaerobic environments:
  ...
  - Dissimilatory nitrate reduction to ammonia (DNRA) - reduces NO~3~^-^ to NO~2~^-^ and then to NH~4~^+^
...
Nitrogenase is destroyed by O~2~, and thus the enzyme needs to be protected from exposure to O~2~. The molecule that protects nitrogenase (leghemoglobin) is virtually the same as hemoglobin that gives blood red its color when oxygenated, hence root nodules on legumes are red.
...
Important as key constituent of essential amino acids, vitamins, enzymes & aromatic oils. Sulfur has three primary "natural" sources:
  ...
  2. Soil minerals - inorganic forms are primarily sulfates and sulfides. Sulfates are directly available to plants whereas sulfides must be oxidized to sulfate form before they may be taken up by plants
  3. Sulfur gases in the atmosphere - primarily COS, H~2~S, and SO~2~ are produced from volcanos, ocean spray, biomass fires and fossil fuel burning. These are eventually oxidized to sulfates which form sulfuric acid and result in acid rain
...
For inorganic P, two primary controls on its availability exist: i) the solubility of P-containing minerals, and ii) the fixation or adsorption of P ions on the surfaces of soil particles.
...
Only present in soil solution as cation, and behavior in soil is thus largely effected by soil cation exchange properties and mineral weathering.
...
Additionally, Thom notes that his five suggested geomorphic settings *are not comprehensive but are rather representative of dominant processes that may be relevant.* Thom goes on to discuss variations and scale in time and space and their resultant effects on mangrove geomorphology. He concludes that zonation of mangrove species responds opportunistically to geomorphic setting, and areas with high geomorphic diversity will have high degrees of habitat variation.
...
**Key findings:** The study concludes that there were key tidal inlets which were eventually breached by rising sea levels and allowed for expanded colonization of the calcerous bedrock by mangroves. Soil depths and cores indicate that there was a forest of landlocked mangroves at one point during low-levels (200 cm below present), but the authors are unsure of how tidal fluxes reached this area.
...
**Key additions:** The carbonate settings that Thom adds to his original five clastic settings are as follows:
  ...
  7. *Sand/shingle barrier* - Mangroves may form on cemented or non-cemented coral detritus, for example patchy mangroves colonizing portions of the Great Barrier Reef. Sand mostly consists of carbonate particles and sea levels play an important part on depositional characteristics
  8. *Carbonate embayments* - Embayments in which soil "crusts" were submerged by SLR during Holocene. For example, patchy mangroves on old reef complexes that are highly variable and reflect varability in the substrate complexity.
...
**Key knowledge:** In addition, Thom discusses some of the prior models of succession and zonation in mangroves. In particular he identifies three trends of research, including one in which he situates himself:
  ...
  2. *"Environmental gradient view"* - The more "ecological niche" based view of vegetation patterning that results from environmental gradients; Watson 1928 and his description of inundation classes was one of first studies to argue for this effect
...
**Key notes: **
  ...
  - The ability of mangrove forests to respond to different levels of sea level rise depends on coastal morphology
...
*Stratigraphy and paleoecology:*
  ...
  - Woodroffe examines three patterns of tropical geomorphological development:
    ...
    3. Carbonate banks or reefs - predominantly characterized by in situ production of sediments
...
**Key contribution: ** This is a very well-cited study that experimentally examines biological controls on soil elevation in mangroves of the Meso American Barrier Reef (in Belize). 

**Study design: ** The authors installed elevation rods with rod surface elevation tables (RSETs) that were able to measure changes in elevation from a baseline over the course of three years in fringe, transition and interior mangroves. They examined the effects of nutrient additions (N, P & a control) across three transects at three replicate sites. 

In addition, they laid a sand horizon in a plot adjacent to the RSETs and used cores to monitor subsurface accretion, allowing for differentiation between subsurface accretion and surface accretion of biomass to elevation. Finally, the authors examine several cores (up to 10m in depth) across sites throughout the Caribbean to examine relative SLR and mean soil accretion.

**Key results: ** The authors conclude that the fringe portion of the forests are able to keep pace with sea level rise, primarily due to subsurface accumulation of biomass (significantly correlated with elevation change). 

The fringe zone was found to have significantly positive gain in elevation, with majority from subsurface change, whereas interior and transition zones saw subsidence. Elevation gains were seen across all sites for P addition, whereas elevation gain was variable in direction for N (negative in interior).
...
The results from the mangrove peat cores showed that peat accumulation corresponded with rates of SLR over the past 6,000-7,000 years. Although they are currently keeping pace with sea level rise, the cores show that at points (in which SLR exceeded 5 mm / yr), mangroves were lost from the area. 

Thus, the presence of mangroves at these sites depends on relative SLR rates (eustatic rise plus local subsidence/elevation gains). Rates of mangrove peat accretion, however, may underestimate the ability to respond to SLR as these are often based on mean rates from historical records that likely fluctuate significantly in response to SLR.

### Woodroffe, 2016

*"Mangrove sedimentation and response to relative sea level rise"* [@woodroffe2016mangrove]

**Key contribution: ** This study is a review of sedimentary processes and geomorphology with a particular focus on their responses to relative sea level rise. The study introduces the concept of the "accommodation space" in the context of mangroves, which is the space available for potential sediment accumulation.
...
"The distribution of mangrove species coincides with the intertidal accommodation space, which progressively fills through sediment accumulation. Emergent properties and biocomplexity are a function of hydroperiod and are related to salinity and flooding tolerance, the latter of which is related to root morphologies, physiology, and reproductive traits such as vivipary."

*Accommodation space* - the space available for potential sediment accumulation. Typically see highest accomodation space at shoreline in mangroves, though it may be highly variable (e.g., basin areas that are only flooded during highest tides).

  - may distinguish between mineral vs. biological accretion, and thus may consider "ecological accommodation space"
  
Rates of sedimentation depend upon the accommodation space, which depends on hydrology and other factors. In the short term, the rate of sediment deposition appears to be independent of the rate of SLR. The accommodation space is directly constrained by the upper limit of tidal flooding.
...
*"Mangrove hydrodynamics"* [@wolanski1992mangrove]
...
*Tidal asymmetry* - Currents in tidal creeks are strong during ebb flow relative to flood flow.
...
$$ u = \frac{1}{n}\ *\ h^{\frac{2}{3}}\ *\ I^{\frac{1}{2}}  $$
...
Sedimentation rates decreased with distance from the tidal creek. In calculating the sedimentation velocity, the median floc size (90 micrometers) was approximately 4 times the size of solid minerals (24 micrometers) given high porosity of flocs. Visual investigation of suspended sediment reveals that much of the flocs had settled out of the water column following slack high tide.
...
**Key results:** The results provided several key findings:
  ...
  - No significant differences among functional root types for elevation change were found across all basins, but root type by river basin interactions were found to be significant (control plots or pneumatophores having higher rates of positive sediment surface elevation change).
    - Rates of elevation change were found to occur through series of "pulses" rather than steady through time
    - A lower rate of surface elevation change in Rhizophora was suggested to potentially be due to the lower ratio of lignin:nitrogen in the fine root fraction, which may have been more decomposible and thus result in elevation decreases.
  - Root area and root density did not have significant influence on monthly rates of vertical accretion.

Furthermore, the authors found that surface elevation change in Avicennia pneumatophores was highest, and the authors conclude that organic matter contribution is thus significant, which might have implications for research questions.
...
**Study design:** The study primarily employs petri dishes held to the forest floor as well as water samples to examine differences in total suspended sediment, sediment accretion and the presence of glomalin (a secretion produced by terrestrial arbuscular mycorrhizal fungi) across forest types/settings.
...
Several key questions exist per understanding the role of SOC in the global CO~2~ cycle:
  ...
  2. What is the effect of cultivation on SOC storage and atmospheric CO~2~? Several key points are provided:
...
$$\delta X = (\frac{R_{sample}}{R_{standard}}-1)*1,000 $$
Where:
...
The author attribute the spatial variation in geochemical conditions to different periods of inundation in which soils are exposed, response to positions within the mangrove forest, and the composition (texturally and chemically) of the substrate.
  ...
  - Basin forest - strongly reduced conditions due to long periods of inundation from concave profile; anoxic conditions within the profile favor synthesis of pyrite rather than Fe^2+^ and HS^-^ in pore water. Predominance of pyrite synthesis is due to high availability of OM, which maintains activity of sulfate-reducing bacteria. 
